                    ...
                    data: {
                      ...
                      properties: {
                        ...
                        biodata: {
                          type: 'object',
                          properties: {
                            nim: { type: 'string', example: '' },
                            nama: { type: 'string', example: '' },
                            jenis_kelamin: { type: 'string', example: '' },
                            status_kawin: { type: 'string', example: '' },
                            tempat_lahir: { type: 'string', example: '' },
                            tanggal_lahir: { type: 'string', example: '' },
                            ...
                            alamat_asal: { type: 'string', example: '' },
                            ...
                            foto: { type: 'string', example: '' },
                            kode_prodi: { type: 'string', example: '' },
                            semester_masuk: { type: 'string', example: '1' },
                            no_peserta: { type: 'string', example: '' },
                            gelombang: { type: 'string', example: '1' },
                            kode_fak: { type: 'string', example: '1' },
                            ...
                            krslapor: { type: 'string', example: '1' },
