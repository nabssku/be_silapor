                      ...
                      properties: {
                        ...
                        biodata: {
                          ...
                          properties: {
                            ...
                            status_kawin: { type: 'string', example: '' },
                            tempat_lahir: { type: 'string', example: 'Makassar' },
                            tanggal_lahir: { type: 'string', example: '24 Februari 2006' },
                            warga_negara: { type: 'string', example: '' },
                            agama: { type: 'string', example: '' },
                            telp: { type: 'string', example: '' },
                            email: { type: 'string', example: 'nabils24_informatika_357@webmail.umm.ac.id' },
                            email_alternate: { type: 'string', example: '' },
                            blog_umm: { type: 'string', example: '' },
                            alamat_asal: { type: 'string', example: 'Jalan Warinoi 5 No 2, Kel. Bunulrejo, Kec. Blimbing. Malang, Jawa Timur RT. 11 RW. 14, Desa/Kel. Bunulrejo, Kec. Blimbing, Malang (Kota), JAWA TIMUR, Indonesia, 65123' },
                            alamat_sekarang: { type: 'string', example: '' },
                            tahun_masuk: { type: 'string', example: '2024' },
                            terdaftar: { type: 'string', example: 'Peserta Didik Baru' },
                            prodi: { type: 'string', example: 'Informatika' },
                            fakultas: { type: 'string', example: 'Fakultas Teknik' },
                            refjenjang: { type: 'string', example: 'C' },
                            jenjang: { type: 'string', example: 'S-1' },
                            ref_akademik: { type: 'string', example: 'A' },
                            status_akademik: { type: 'string', example: 'Aktif' },
                            foto: { type: 'string', example: 'https://krs.umm.ac.id/Poto/2024/202410370110357.JPG' },
                            kode_prodi: { type: 'string', example: '037' },
                            semester_masuk: { type: 'string', example: '1' },
                            no_peserta: { type: 'string', example: '2412797' },
                            gelombang: { type: 'string', example: '1' },
                            kode_fak: { type: 'string', example: '05' },
                            ref_terdaftar: { type: 'string', example: '1' },
                            ref_asal_pt: { type: 'string', example: '' },
                            ref_masuk: { type: 'string', example: '1' },
                            alamat_wali: { type: 'string', example: '' },
                            krslapor: { type: 'string', example: '11' },
                            k: { type: 'string', example: '1' },
                          },
                        },
                      },
                    },
